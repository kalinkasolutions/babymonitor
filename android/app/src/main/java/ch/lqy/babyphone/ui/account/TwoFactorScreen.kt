package ch.lqy.babyphone.ui.account
...
import ch.lqy.babyphone.account.TwoFactorState
...
private fun AlreadyOn(
    ...
    Spacer(Modifier.height(16.dp))
    OutlinedButton(onClick = onRegenerateCodes, enabled = !busy, modifier = Modifier.fillMaxWidth()) {
