...
namespace Babyphone.BusinessLogic.Services.Account;

public sealed class AccountService : IAccountService
{
    private const string Issuer = "Babyphone";
    ...
    private async Task<AccountDto> ToDtoAsync(BabyphoneUser user) => new()
    {
        UserId = user.Id,
