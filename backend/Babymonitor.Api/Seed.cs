...
public static class Seed
{
    ...
    public static async Task InitializeAsync(WebApplication app)
    {
        ...
        var db = services.GetRequiredService<BabymonitorContext>();
        ...
        if (app.Environment.IsDevelopment())
        {
            await EnsureSeedUsersAsync(
                services.GetRequiredService<UserManager<BabymonitorUser>>(),
    ...
    private static async Task EnsureSeedUsersAsync(
        UserManager<BabymonitorUser> userManager, SeedUserOptions options, ILogger logger)
    {
