...
/// <see cref="BabymonitorUser.UserName"/> is a display name and an account is identified by its email
...
/// </summary>
public sealed class DisplayNameUserValidator : UserValidator<BabymonitorUser>
{
    public DisplayNameUserValidator(IdentityErrorDescriber? errors = null) : base(errors)
    {
    }

    public override async Task<IdentityResult> ValidateAsync(UserManager<BabymonitorUser> manager, BabymonitorUser user)
    {
